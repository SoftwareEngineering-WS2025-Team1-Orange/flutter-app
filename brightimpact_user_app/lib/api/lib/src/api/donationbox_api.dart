...
class DonationboxApi {
  ...
  Future<Response<List<DonationboxDto>>> getDonationbox({ 
    ...
    List<DonationboxDto>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<DonationboxDto>, DonationboxDto>(rawData, 'List<DonationboxDto>', growable: true);
    ...
    return Response<List<DonationboxDto>>(
      data: _responseData,
  ...
  Future<Response<void>> registerDonationbox({ 
    ...
    try {
_bodyData=jsonEncode(donationboxRegisterDto);
    } catch(error, stackTrace) {
      throw DioException(
