...
class TokenApi {
  ...
  Future<Response<ResponseTokenDto>> getToken({ 
    ...
    ResponseTokenDto? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ResponseTokenDto, ResponseTokenDto>(rawData, 'ResponseTokenDto', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<ResponseTokenDto>(
      data: _responseData,
